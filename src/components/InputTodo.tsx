  ...
  return (
    <>
      <div className="flex [&>*]:dark:bg-very-dark-desaturated-blue [&>*]:bg-very-light-gray w-full gap-x-3">
        <span className="inline-block w-[20px] lg:w-[26px] h-auto rounded-full border-[1px] border-dark-grayish-blue dark:border-very-light-grayish-blue-alpha self-center aspect-square"></span>
        <input
